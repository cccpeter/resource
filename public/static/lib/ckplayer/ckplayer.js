	...
	return {
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			loading: {
				...
				file: 'data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAFCAYAAABmWJ3mAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAfSURBVBhXY2Dg5vuPFWMVBGGsgiCMVRCEsQpy8/0HANauINFRb7UPAAAAAElFTkSuQmCC',
				align: 'center',
				vAlign: 'middle',
				offsetX: -100,
				offsetY: -40
...
!(function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		this.config = {
			videoClick: false, //是否支持单击播放/暂停动作
