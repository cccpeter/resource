<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpStudy\PHPTutorial\WWW\resource/application/base\view\common\login.html";i:1539222176;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/resource/public/static/lib/h-ui/css/H-ui.min.css"/>
    <link rel="stylesheet" href="/resource/public/static/lib/h-ui.admin/css/H-ui.login.css"/>
    <link rel="stylesheet" href="/resource/public/static/lib/Hui-iconfont/1.0.8/iconfont.css"/>
    <link rel="stylesheet" href="/resource/public/static/lib/icheck/skins/flat/blue.css"/>
    <title>登录 - </title>
</head>
...
<div class="loginWraper">
    ...
    <div style="width: 400px;height: 400px; position: absolute; position: absolute;right: 0px;bottom: 0px;">
        <img  style="position: absolute;right: 20px;bottom: 100px;width:100px;height: 100px;" src="/resource/public/static/images/qrios.png">
        <img style="position: absolute;right: 20px;bottom: 300px;width:100px;height: 100px;" src="/resource/public/static/images/qrandroid.png">
    </div>
</div>
<div class="footer hidden-xs"  style="background-color: #4474BB;height: 44px;padding: 0;"></div>
</body>
<script type="text/javascript" src="/resource/public/static/js/jquery.min.js"></script>
<script type="text/javascript" src="/resource/public/static/lib/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="/resource/public/static/lib/layer/layer.js"></script>
<script type="text/javascript" src="/resource/public/static/lib/icheck/icheck.min.js"></script>
<script>
    $(function () {
        $('#online').iCheck({
