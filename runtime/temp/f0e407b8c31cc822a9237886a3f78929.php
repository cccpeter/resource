<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\PHPTutorial\WWW\resource/application/index\view\index\myassess.html";i:1539754813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>我的</title>
	...
	<div class="wrap">
		<div class="slider float_l">
			<ul>
				...
				<li>
					<a href="<?php echo url('Index/index/myassess'); ?>" class="actived">
