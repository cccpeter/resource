<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\PHPTutorial\WWW\resource/application/index\view\index\note.html";i:1539754596;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>我的</title>
        ...
        <div class="float_r">
            ...
            <div class="float_l margin_l30 margin_r40">
				...
				<div class="userinfo userinfo-hoverls" id="userinfoset">
					...
					<div class="float_l">
						<a class="userlist">个人空间</a>
						<a class="userlist">我的收藏</a>
						<a class="<?php echo url('Index/index/note'); ?>">我的笔记</a>
					</div>
					<hr>
	...
	<div class="wrap">
		<div class="slider float_l">
			<ul>
				...
				<li>
					<a href="<?php echo url('Index/index/note'); ?>" class="actived">
				...
				<li>
					<a href="<?php echo url('Index/index/request'); ?>" class="active">
