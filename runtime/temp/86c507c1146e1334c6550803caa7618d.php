<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\PHPTutorial\WWW\resource/application/index\view\person\myrequest.html";i:1539757739;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>我的</title>
	...
	<div class="wrap">
		<div class="slider float_l">
			<ul>
				...
				<li>
					<a href="<?php echo url('Index/person/myrequest'); ?>" class="actived">
		            	<i class="layui-icon" style="font-size: 20px;color: #fff;line-height: 48px;">&#xe609;</i><span style="margin-left: 15px;">我的讨论</span><b class="icon-drop_right"></b>
		            </a>
				</li>
			</ul>
		</div>
