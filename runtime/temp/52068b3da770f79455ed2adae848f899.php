<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\resource/application/index\view\index\publicvideo.html";i:1539754846;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>我的</title>
	...
	<div class="wrap">
		<div class="slider float_l">
			<ul>
				...
				<li>
					<a href="<?php echo url('Index/index/userinfo'); ?>" class="active">
				...
				<li>
					<a href="<?php echo url('Index/index/publicvideo'); ?>" class="actived">
