			...
			<ul>
				<li>
					<a href="<?php echo url('Index/person/mycollect'); ?>" class="actived">
						...
						<span style="margin-left: 15px;">收藏夹</span><b class="icon-drop_right"></b>
		            </a>
				</li>
				<li>
