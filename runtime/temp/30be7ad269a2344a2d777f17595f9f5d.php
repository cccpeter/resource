		...
		<div class="layui-row">
			<div class="layui-col-md8 layui-col-md-offset2 float_l" >
				<ul class="menu">
					...
					<a href="<?php echo url('Index/index/course_resource',['videotab_id'=>$videotab['videotab_id']]); ?>"><li class="ison" style="cursor: pointer;">课程资源/作业</li></a>
