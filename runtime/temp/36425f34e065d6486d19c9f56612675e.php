	...
	<div class="wrap">
		<div class="slider float_l">
			<ul>
				...
				<li>
					<a href="<?php echo url('Index/person/publicvideo'); ?>" class="actived">
		            	<i class="layui-icon" style="font-size: 20px;color: #fff;line-height: 48px;">&#xe681;</i><span style="margin-left: 15px;">公共视频</span><b class="icon-drop_right"></b>
		            </a>
				</li>
				<li>
