...
<script type="text/javascript">
	...
	function time(){
		if(getCookie('token')){
				...
				if(viewtime){
					setCookie('viewtime',viewtime+10,'100');
					alert(getCookie('viewtime'));
				}else{
